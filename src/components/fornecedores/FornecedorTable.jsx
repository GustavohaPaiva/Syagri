...
import { FornecedorNameBadge } from './FornecedorVisuals'
...
export function FornecedorTable({ rows, loading, emptyMessage, onViewDetails }) {
  if (loading) {
    return (
            ...
            >
              <td className="flex items-center justify-between gap-3 border-b border-slate-100/80 py-2.5 md:table-cell md:border-0 md:px-4 md:py-4 md:text-center">
                ...
                <div className="flex justify-end md:justify-center">
                  <FornecedorNameBadge nome={row.nome} />
                </div>
              </td>
