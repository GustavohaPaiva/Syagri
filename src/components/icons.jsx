...
/** Ícones no estilo Lucide (SVG inline — evita dependência externa). */
...
export function IconChevronsLeft({ className }) {
  return (
    <svg {...iconProps(className)}>
...
export function IconUserSwitch({ className }) {
  return (
    <svg {...iconProps(className)}>
      <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
      <circle cx="9" cy="7" r="4" />
      <path d="M17 11h4v-4" />
      <path d="M21 11a6 6 0 0 0-6-6" />
    </svg>
  )
}
